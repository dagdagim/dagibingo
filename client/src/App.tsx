...
import { MinesPage } from './pages/user/MinesPage';
import { HorseRacePage } from './pages/user/HorseRacePage';
...
import { ChickenRoadPage } from './pages/user/ChickenRoadPage';
        ...
        <div className="min-h-screen flex flex-col bg-arena-bg text-arena-text">
          ...
          <main className="flex-1">
            <Routes>
              ...
              <Route path="/chickenroad" element={<ChickenRoadPage />} />
